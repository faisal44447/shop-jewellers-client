        ...
        <div className="p-5 bg-gray-100 min-h-screen">
            ...
            <div className="bg-white rounded-2xl shadow-md p-5 flex items-center gap-4 mb-8">
                ...
                <div>
                    ...
                    <p className="text-gray-500">Manage your jewellery shop dashboard easily</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-white rounded-2xl p-5 h-[450px]">
                    <h2 className="text-orange-500 font-bold mb-4">Product Price Analysis</h2>
                    <ResponsiveContainer width="100%" height="100%">
                        <BarChart data={products} margin={{ top: 10, right: 20, left: 10, bottom: 80 }}>
                ...
                <div className="bg-white rounded-2xl p-5 h-[450px] flex flex-col">
                    <h2 className="text-orange-500 font-bold mb-3">Financial Overview</h2>
                    <div className="flex-1">
                        <ResponsiveContainer width="100%" height="100%">
                            <PieChart>
                                <Pie data={pieChartData} dataKey="value" nameKey="name" outerRadius="70%" label>
