        ...
        <div className="w-full space-y-6 px-2 sm:px-4 py-4 bg-gray-50/50 min-h-screen">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-4 w-full">
                ...
                <div className="col-span-2 md:col-span-3 lg:col-span-4 bg-white p-1 rounded-2xl shadow-sm border border-orange-100">
                    ...
                    <Card
                        title="Final Remaining Cash (Total Cash In - Total Expenses)"
                        value={netBusinessCash}
                        colorClass={`${cashColorClass} text-2xl md:text-3xl font-black`}
                    />
                ...
                <div className="col-span-2 md:col-span-3 lg:col-span-4 mt-2">
                    ...
                    <h4 className="text-xs font-bold text-green-600 uppercase tracking-wider border-b pb-1">

                        Total Cash In Sources (+)
                ...
                <Card
                    title="Total Cash In (Combined)"
                    value={stats.totalCashCombined}
                ...
                <Card
                    title="Added Cash List"
                    value={stats.totalCashFromList}
                    colorClass="text-green-500"
                />

                <Card
                    title="Received / Loan Taken"
                ...
                <div className="col-span-2 md:col-span-3 lg:col-span-4 mt-2">
                    ...
                    <h4 className="text-xs font-bold text-red-600 uppercase tracking-wider border-b pb-1">
                ...
                <Card
                    title="Total Expenses (Combined)"
                    value={stats.totalExpenseCombined}
                ...
                <Card
                    title="Given / Due / Remaining"
                    value={totalTransactionMinus}
                    colorClass="text-red-500"
                />

                {/* ================= STOCK & PROFITS ================= */}
                <div className="col-span-2 md:grid-cols-3 lg:col-span-4 mt-2">

                    <h4 className="text-xs font-bold text-purple-600 uppercase tracking-wider border-b pb-1">
                ...
                <Card
                    title="Manual Added Profit"
                    value={stats.manualProfit}
